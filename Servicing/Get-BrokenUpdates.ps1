...
$brokenUpdates | Get-ItemProperty | Where-Object { $_.CurrentState -ne "80" -and $_.CurrentState -ne "112"} | Select-Object @{N=’Cumulative/rollup package(s) in broken state’; E={$_.PSChildName};} | Format-Table -Wrap -AutoSize
 
...
$brokenUpdates | Get-ItemProperty | Where-Object { $_.CurrentState -ne "80" -and $_.CurrentState -ne "112"} | Select-Object @{N=’Standalone package(s) in broken state’; E={$_.PSChildName};} | Format-Table -Wrap -AutoSize
